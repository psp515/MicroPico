...
class BaseLed():
    ...
    def __init__(self, pin, frequency=1000, default_value=0, interval_break_us=1500):
        """
        ...
        self._duty = self._calc_duty(default_value)
    ...
    def _on_duty(self):
        """
        Method created in case of rgb led (anode / katode)
        :return: Returns duty value for led on state.
        """
        return MAX_PWM_DUTY